...
// =========================================================
//
// Gradually increase pressure on the payment system.
//
// 10 VUs
//   ↓
// 25 VUs
...
// 150 VUs
//
// Unlike SPIKE, there is no sudden jump.
// The objective is to progressively approach
...
export function setup() {
    ...
    console.log(
        "Stress profile   : 10 → 25 → 50 → 100 → 150 VUs",
    );
